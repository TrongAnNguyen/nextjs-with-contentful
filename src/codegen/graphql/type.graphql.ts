...
/** [See type definition](https://app.contentful.com/spaces/hvfu0i31bzhm/content_types/author) */
...
export type AuthorLinkingCollectionsBookCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<AuthorLinkingCollectionsBookCollectionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
};
...
export enum AuthorLinkingCollectionsBookCollectionOrder {
  NameAsc = 'name_ASC',
  NameDesc = 'name_DESC',
  SysFirstPublishedAtAsc = 'sys_firstPublishedAt_ASC',
  SysFirstPublishedAtDesc = 'sys_firstPublishedAt_DESC',
...
/** [See type definition](https://app.contentful.com/spaces/hvfu0i31bzhm/content_types/book) */
...
export type GetHomesQuery = { __typename?: 'Query', homeCollection?: { __typename?: 'HomeCollection', items: Array<{ __typename?: 'Home', name?: string, address?: string }> } };
